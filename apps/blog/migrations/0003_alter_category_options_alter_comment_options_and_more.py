...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='category',
            name='name_kk',
            field=models.CharField(default='', max_length=100, verbose_name='Category name (Kazakh)'),
        ),
        migrations.AddField(
            model_name='category',
            name='name_ru',
            field=models.CharField(default='', max_length=100, verbose_name='Category name (Russian)'),
        ),
