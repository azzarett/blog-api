...
DEFAULT_FLOWER_USER = 'admin'
DEFAULT_FLOWER_PASSWORD = 'changeme'
DEFAULT_SEED_DB = False
...
BLOG_EMAIL_BACKEND = config(
    'BLOG_EMAIL_BACKEND', default=DEFAULT_EMAIL_BACKEND)
BLOG_DEFAULT_FROM_EMAIL = config(
    'BLOG_DEFAULT_FROM_EMAIL', default=DEFAULT_FROM_EMAIL)


BLOG_CELERY_BROKER_URL = config(
    'BLOG_CELERY_BROKER_URL', default=DEFAULT_CELERY_BROKER_URL)

BLOG_FLOWER_USER = config('BLOG_FLOWER_USER', default=DEFAULT_FLOWER_USER)
BLOG_FLOWER_PASSWORD = config(
    'BLOG_FLOWER_PASSWORD', default=DEFAULT_FLOWER_PASSWORD)

BLOG_SEED_DB = config('BLOG_SEED_DB', default=DEFAULT_SEED_DB, cast=bool)
